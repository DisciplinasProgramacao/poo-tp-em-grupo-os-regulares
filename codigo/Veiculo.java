...
public class Veiculo {
     ...
     * @param a dígitos da placa tipo String e a capacidade máxima do tanque tipo Double
     */

	public Veiculo(String placa, double tanqueMax) {
		this.placa = placa;
		tanque = new Tanque(tanqueMax);
	...
	/**
     * Método que verifica se a rota que deseja adicionar está no mesmo mês da ultima adicionada
	 *  @param Rota 
	...
	/**
     * Método que simula a ação de percorrer uma rota em um veículo, consumindo combustível do tanque com base na quilometragem da rota e no consumo do veículo (CONSUMO).
	 * @param tipo Rota.
	 */
