...
public class Frota {
     ...
     * Este método utiliza um StringBuilder chamado aux2 para concatenar informações sobre cada veículo em um array (veiculos).
	...
	public void adicionarVeiculo (Veiculo add)
	{
			...
			else System.out.println("Erro ao adicionar na frota");
			
		
	}

	/**
     * Método tem como objetivo procurar um veículo com uma placa específica dentro de um array de veículos (veiculos)
	 ...
	 *  A quilometragem total é obtida somando os quilômetros totais individuais de cada veículo no array.
	...
	/**
     * Método para percorrer um array de veículos (veiculos) para encontrar o veículo com a maior quilometragem total.
	...
	/**
     * Método para percorrer um array de veículos (veiculos) para encontrar o veículo com a maior média de quilometragem por rota entre todos os veículos..
